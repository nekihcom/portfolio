...
export function Header() {
  ...
  return (
    <header
      className={`max-w-[960px] rounded-b-xl rounded-bl-xl mx-auto fixed top-0 left-0 right-0 z-50 border-b border-black/10 shadow-lg transition-all duration-300 dark:border-white/10 ${
        isScrolled
          ? "h-[60px] bg-transparent backdrop-blur-sm"
          : "h-[80px] bg-white/95 backdrop-blur-sm dark:bg-black/95"
      }`}
    >
